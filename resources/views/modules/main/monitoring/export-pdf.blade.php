       ...
       <tbody>
         @foreach ($record as $item)
          <tr>
            ...
            <td>{{$item->area}}</td>
            <td>{{$tanggal}}</td>
            <td>{{$item->absen ? ($item->absen->date_in != null ? Carbon::parse($item->absen->date_in)->format('H:i') : '-') : '-'}}</td>
            <td>{{$item->absen ? ($item->absen->date_out != null ? Carbon::parse($item->absen->date_out)->format('H:i') : '-') : '-'}}</td>
            <td>{{$item->area}}</td>
            <td>{{ucfirst($item->absen->status ?? '-')}}</td>
            <td>{{ucfirst($item->absen->keterangan ?? '-')}}</td>
          </tr>
         @endforeach
       </tbody>
    </table>
